...
if analysis == '2024 LA Wildfires':
    ...
    for i in range(len(files)):
        ...
        ax[1, i].set_extent((238, 244, 31, 37), cartopy.crs.PlateCarree())
        ax[1, i].add_feature(cartopy.feature.COASTLINE, edgecolor='grey')
        ...
        ax[1, i].pcolormesh(lons, lats, to_plot, cmap=cmap, norm=c_norm, transform=cartopy.crs.PlateCarree())
        ax[1, i].set_title(title_map[files[i]])
